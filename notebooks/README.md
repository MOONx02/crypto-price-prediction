...
- **Version = pipeline only.** The current notebook is `Crypto_Colab_AllInOne_v6.ipynb` (rolling backtest, TimeSeriesSplit + RandomizedSearchCV, residual plots, Phase 4 ablation, **Phase 5 interpretability**).
...
| **v6** | v5 + **Phase 5 interpretability** (permutation importance, PDP/ICE, error analysis). Current. Asset chosen via `ASSET` in notebook. |
...
- **Crypto_Colab_AllInOne_v1.ipynb**, **v2.ipynb**, **v3.ipynb**, **v4.ipynb**, **v5.ipynb** — superseded by v6.
