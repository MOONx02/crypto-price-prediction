...
- **Current working notebook:** `Crypto_Colab_AllInOne_vN.ipynb` (use the **highest** version number in this folder). Right now: **v3**.
...
| **v3** | Improvement: + volume and rolling volatility (data, Lag+Ridge, LSTM). LSTM Dir.Acc ~51%. |
